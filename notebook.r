...
# Label the y-axis
#tibble::glimpse(confirmed_cases_worldwide$cum_cases)
#head(confirmed_cases_worldwide$date)
#ylim=c(min(confirmed_cases_worldwide$cum_cases),max(confirmed_cases_worldwide$cum_cases))
#plot(x=confirmed_cases_worldwide$date, y=confirmed_cases_worldwide$cum_cases, ylim=ylim)))
print(data.frame(confirmed_cases_worldwide$date))
confirmed_cases_worldwide$date<-as.Date(confirmed_cases_worldwide$date,"%Y-%m-%d")
ggplot(confirmed_cases_worldwide, aes(date, cum_cases)) +
 geom_line(aes(date,cum_cases, colour="is worldwide")) +
...
# See the result
tibble::glimpse(confirmed_cases_china_vs_world)
confirmed_cases_china_vs_world$date<-as.Date(confirmed_cases_china_vs_world$date,"%Y-%m-%d")
...
ggplot(data=confirmed_cases_top7_outside_china,aes(date, cum_cases))+
geom_line(data=confirmed_cases_top7_outside_china,aes(date,cum_cases, colour=country))+labs(ylab="Cumulative confirmed cases")
